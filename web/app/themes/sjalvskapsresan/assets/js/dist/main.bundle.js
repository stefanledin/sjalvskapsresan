...
/******/ 		return __webpack_require__.p + "" + ({"SidebarNav":"SidebarNav","vendors~Counter":"vendors~Counter","Counter":"Counter"}[chunkId]||chunkId) + ".bundle.js"
/******/ 	}
/******/
...
/******/ 	__webpack_require__.p = "/app/themes/sjalvskapsresan/assets/js/dist/";
/******/
...
eval("const WebFont = __webpack_require__(/*! webfontloader */ \"./node_modules/webfontloader/webfontloader.js\");\nWebFont.load({\n    google: {\n        families: ['Pacifico']\n    }\n});\n\ndocument.querySelector('button.plask').addEventListener('click', event => {\n    event.preventDefault();\n    document.querySelector('div.posts-pile--animateable').classList.add('posts-pile--run-animation');\n});\ndocument.querySelector('button.slask').addEventListener('click', event => {\n    event.preventDefault();\n    const pile = document.querySelector('div.posts-pile--animateable');\n    pile.classList.add('posts-pile--reset-animation');\n    setTimeout(() => {\n        pile.classList.remove('posts-pile--run-animation', 'posts-pile--reset-animation');\n    }, 1000);\n});\n\nconst passedEvents = document.querySelectorAll('.timeline__item--passed')\nif (passedEvents) {\n    let scrollValue = 0;\n    passedEvents.forEach(item => scrollValue += item.clientWidth);\n    //document.querySelector('.timeline__items-wrapper').scrollLeft = scrollValue;\n}\n\ndocument.addEventListener('DOMContentLoaded', (event) => {\n    __webpack_require__.e(/*! import() | SidebarNav */ \"SidebarNav\").then(__webpack_require__.bind(null, /*! ./SidebarNav */ \"./assets/js/src/SidebarNav.js\")).then(SidebarNav => {\n        new SidebarNav.default();\n    });\n    Promise.all(/*! import() | Counter */[__webpack_require__.e(\"vendors~Counter\"), __webpack_require__.e(\"Counter\")]).then(__webpack_require__.bind(null, /*! ./Counter */ \"./assets/js/src/Counter.js\")).then(Counter => {\n        new Counter.default();\n    });\n});//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./assets/js/src/app.js\n");
